...
export default function ResourcesPage() {
  const resources = [
    ...
    },
    {
      ...
      description: 'A complete toolkit with surveys, analysis templates, and evaluation frameworks.',
      readTime: 'Download',
    ...
    },
    {
      ...
      description: 'A complete strategic guide to digital transformation for Chinese enterprises entering North America.',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
              ...
              <div key={index} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow border border-gray-200">
                <div className="h-48 bg-cover bg-center relative" style={{ backgroundImage: `url(${resource.image})` }}>
                  <div className="absolute top-4 left-4">
                    <span className="bg-red-500 text-white px-2 py-1 rounded text-xs font-medium">Featured</span>
                  </div>
                </div>
                <div className="p-6">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-sm font-medium text-blue-600 bg-blue-100 px-2 py-1 rounded">{resource.type}</span>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {resource.externalUrl ? (
                      ...
                      <span className="text-blue-600 font-medium text-sm whitespace-nowrap cursor-pointer">Read More →</span>
                    )}
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">All Resources</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <section className="py-16 bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">Our professional team is ready to provide personalized consulting services.</p>
